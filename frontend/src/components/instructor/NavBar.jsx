        ...
        <div className="max-w-screen-xl px-4 py-3 mx-auto">
          ...
          <div className="md:hidden">
            <button
              ...
              type="button"
              className="inline-flex items-center text-sm text-gray-50 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-50 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
            >
