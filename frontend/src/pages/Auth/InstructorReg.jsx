...
const Register = () => {
  ...
  // Add handleChange function to handle form input changes
  const handleChange = (e) => {
    setFormData({ ...formData, [e.target.name]: e.target.value });
  };

  // Add handleSubmit function to handle registration form submission
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // No OTP handling, so directly navigate or handle success here
      } else {
        console.error('Error:', data); // Log the error data
